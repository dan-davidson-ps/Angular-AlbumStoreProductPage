...
describe('ProductDescription', () => {
  ...
  it(`should use image url data from the albumInfo property in the HTML template @product-description-html-uses-dynamic-albuminfo-imageurl`, async(() => {
    ...
    if (htmlString != "") {
      ...
      since('We\'d like you to query the albumInfo property directly for the cover image, and we\'re not seeing that you\'re doing that.').expect(imgsrc.match(re)).toEqual(jasmine.any(Array));
    } else {
